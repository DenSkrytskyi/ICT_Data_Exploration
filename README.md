...
This project provides an **exploratory analysis of key Information and Communication Technology (ICT) indicators** for selected countries.  
All visualizations are embedded in the notebook and also saved in the [figures](figures/) folder for easy access.
...
- Focus on easy-to-read charts.
- All visualizations are ready to view directly.
- Analysis emphasizes both trends and country comparisons.
...
> Note: All analyses in the notebook are filtered for these countries.
